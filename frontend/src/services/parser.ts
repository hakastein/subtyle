...
export async function extractTrack(videoPath: string, trackIndex: number, trackTitle: string): Promise<SubtitleFile> { return window.go.main.App.ExtractTrack(videoPath, trackIndex, trackTitle) }
